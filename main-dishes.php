...
<head>
    ...
    <link rel="stylesheet" href="CSS/menu-category-styles/main-dishes.css">
    <link rel="stylesheet" href="CSS/menu-category-styles/main-menu-styles.css">
    <link rel="stylesheet" href="CSS/main.css">

    <title>Menu | Main Dishes</title>
</head>
...
<body>
    ...
    <main>
        <section>
            <div class="main-dishes-header">
                <h1><i>Main Dishes</i></h1>
            </div>
        </section>
